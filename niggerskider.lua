local ui_options = {
	main_color = Color3.fromRGB(6, 89, 21),
...
local Window = library:AddWindow("shit post skid", {
...
game.StarterGui:SetCore("SendNotification", {
    Title = "nigger";
    Text = "cynical ontop axy is a niggerXD";
    Icon = "RBXID OR BLANK";
    Duration = "DURATION IN SECONDS";
    callbakc = bindableFunction;
    Button1 = "damn right axy is a pedo";
})
...
CreditTAB:AddButton("cynicдl#0001 i legit skided this gui", function(bool)
    setclipboard("i skid guis LOLAAAOAMAM axys a pedo")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
...
CreditTAB:AddButton("cum", function(bool)
    setclipboard("nigger XD")
    wait(1)
    local function callback(text)
        if text == "Yes" then
        print("User said yes")
